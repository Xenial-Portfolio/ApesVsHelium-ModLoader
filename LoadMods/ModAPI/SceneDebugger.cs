...
namespace LoadMods.ModAPI
{
    public class SceneDebugger : MonoBehaviour
    {
        int HierarchyWindowId;
        int ProjectWindowId { get { return HierarchyWindowId + 1; } }
        int InspectorWindowId { get { return ProjectWindowId + 1; } }
        int Margin = 50;
        Rect HierarchyWindow;
        int HierarchyWidth = 400;
        ...
        Rect ProjectWindow;
        int ProjectWidth = 400;
        Vector2 ProjectScrollPos;
        ConcurrentDictionary<object, bool> ExpandedObjects = new ConcurrentDictionary<object, bool>();
        ...
        public void OnGUI()
        {
            HierarchyWindow = GUILayout.Window(HierarchyWindowId, HierarchyWindow, HierarchyWindowMethod, "Hierarchy", new GUILayoutOption[0]);
            ProjectWindow = GUILayout.Window(ProjectWindowId, ProjectWindow, ProjectWindowMethod, "Project", new GUILayoutOption[0]);
        }
        #region Hierarchy GUI
        void DisplayGameObject(GameObject gameObj, int level)
        {
        ...
        void HierarchyWindowMethod(int id)
        {
        ...
        #endregion
        #region Project GUI
        void ProjectWindowMethod(int id)
        {
            GUILayout.BeginVertical(GUIContent.none, GUI.skin.box, new GUILayoutOption[0]);// GUI.skin.box);
            {
